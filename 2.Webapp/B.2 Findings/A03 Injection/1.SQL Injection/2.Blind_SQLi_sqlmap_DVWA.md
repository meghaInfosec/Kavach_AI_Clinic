...
![Burp/FoxyProxy setup](INSERT_IMAGE_HERE)
...
![Captured HTTP request in Burp saved as DVWA.txt](INSERT_IMAGE_HERE)
...
![sqlmap basic injection test output](INSERT_IMAGE_HERE)
...
![List of databases found](INSERT_IMAGE_HERE)
