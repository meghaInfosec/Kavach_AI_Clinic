...
![Captured HTTP request in Burp saved as DVWA.txt](Evidences/15.jpg)
---
...
![sqlmap basic injection test output — resumed session showing confirmed boolean-based and time-based blind injection](Evidences/190.jpg)
---
